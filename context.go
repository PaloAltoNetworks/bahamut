...
// WriteWebsocketResponse writes the final response to the given websocket.Conn.
//
// This is mostly used by autogenerated code, and you should not need to use it manually.
func (c *Context) WriteWebsocketResponse(ws *websocket.Conn, response *elemental.Response) error {
